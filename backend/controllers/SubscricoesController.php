...
use backend\models\SubscricoesSearch;
...
class SubscricoesController extends Controller
{
    ...
    /**
     * Creates a new Subscricoes model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return string|\yii\web\Response
     */
    public function actionCreate()
    {
        $model = new Subscricoes();
    ...
    /**
     * Updates an existing Subscricoes model.
    ...
    /**
     * Deletes an existing Subscricoes model.
